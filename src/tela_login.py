...
class TelaLogin:
    def __init__(self, root: Tk, callback_sucesso):
        ...
        self.root.title("Login - Sistema de Automação")
    ...
    def criar_widgets(self):
        ...
        label_usuario = Label(self.login_frame, text="Usuário",
                              font=('Arial', 12), bg='#f0f0f0')
        label_usuario.pack(anchor='w')
        self.entry_usuario = Entry(
            self.login_frame, font=('Arial', 12), width=30)
        self.entry_usuario.pack(pady=(5, 10))

        label_senha = Label(self.login_frame, text="Senha",
                            font=('Arial', 12), bg='#f0f0f0')
